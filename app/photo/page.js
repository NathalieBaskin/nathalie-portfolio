  ...
  const categories = [
    {
      ...
      cover: photoIndex["brollop-och-forlovning"]?.cover?.src ?? null,
    ...
    },
    {
      id: "photo-children",
      slug: "barn",
      cover: photoIndex["barn"]?.cover?.src ?? null,
    ...
    },
    {
      id: "photo-family",
      slug: "familj",
      cover: photoIndex["familj"]?.cover?.src ?? null,
    ...
    },
    {
      id: "photo-model",
      slug: "modell",
      cover: photoIndex["modell"]?.cover?.src ?? null,
